 ...
 * @since    1.0.0
 */
class Wtf_Filter_PaginateRelPrev extends Wtf_Filter
{
    /**
     * {@inheritDoc}
     */
    protected $m_tag = 'previous_posts_link_attributes';
    /**
     * {@inheritDoc}
     */
    ...
    {
        return 'ページ切り替えリンクにrel=prev属性を追加します。';
    }
